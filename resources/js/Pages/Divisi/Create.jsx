...
/**
 * Halaman Form Tambah Divisi
 * Form untuk menambahkan divisi baru tanpa modal
 */
export default function DivisiCreate({ auth }) {
        ...
        >
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-neutral-900">Tambah Divisi</h1>
                        <p className="text-neutral-600 mt-1">Tambahkan divisi baru ke sistem</p>
                    </div>
                </div>
